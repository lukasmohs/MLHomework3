...
opt <- optim(par=rep(0,6), fn=sq_loss, y=df$y, x1=df$x1, x2=df$x2)
opt$par
lr$coefficients


ggplot(data.frame(x1=c(0, 2)), aes(x1)) + stat_function(fun=test)
test = function(x1) {
  lr$coefficients[1]+x1*lr$coefficients[2]
}
